...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, StatusBadgeComponent, PageHeaderComponent, TableToolbarComponent, PaginationComponent],
...
`;
  ...
  private applyFilters(): void {
    ...
    const filtered = this.allRows().filter((row) => {
      ...
      return matchesTerm && matchesDate && matchesMode && matchesStatus && matchesCustomer;
    });
