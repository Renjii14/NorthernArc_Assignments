...
export const routes: Routes = [
	{ path: '', pathMatch: 'full', loadComponent: () => import('./components/public/landing-page/landing-page.component').then((m) => m.LandingPageComponent), data: { title: 'Lendora' } },
	{
		path: 'login',
	...
	{ path: 'logout', loadComponent: () => import('./components/auth/logout/logout.component').then((m) => m.LogoutComponent), canActivate: [authGuard] },
	{
		...
		children: [
			...
			{ path: 'reports', loadComponent: () => import('./components/placeholders/placeholder.component').then((m) => m.PlaceholderComponent), canActivate: [roleGuard], data: { title: 'Reports', subtitle: 'Analytics and exports', roles: ['MANAGER', 'ADMIN'] } },
			{ path: 'settings', loadComponent: () => import('./components/placeholders/placeholder.component').then((m) => m.PlaceholderComponent), data: { title: 'Settings', subtitle: 'Configuration and preferences' } }
		]
	},
