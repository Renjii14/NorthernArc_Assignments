...
public class AuthController {
    ...
    public LoginResponseDTO login(@Valid @RequestBody LoginRequestDTO request) {
        ...
        if (!customer.isActive()) {
            log.warn("Login failed: customer is deactivated for email={}", request.getEmail());
            throw new org.springframework.security.authentication.BadCredentialsException("Account is deactivated");
        }
    ...
    public ResponseEntity<RegisterResponseDTO> register(@Valid @RequestBody RegisterRequestDTO request) {
        ...
        log.info("Registration successful for email={} customerId={}", 
