...
export class AuthService {
    ...
    return new Observable((observer) => {
      this.apiClient.post<AuthResponseDTO>(`${API_ENDPOINTS.AUTH}/login`, credentials).subscribe({
        next: (response) => {
          ...
          // Reload user-specific cart and favorites after login
          this.cartService.reloadCart();
          this.favoriteService.reloadFavorites();
  ...
  logout(): void {
    ...
    // Clear in-memory cart and favorites state, but do NOT delete from localStorage
